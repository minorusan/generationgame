...
namespace Core.ObjectPooling
{
	public class PoolManager : MonoBehaviour
	{
		...
		public GameObject ReuseObject(GameObject prefab, Vector3 position, Quaternion rotation, object parameters = null)
		{
			...
			if (_poolDictionary.ContainsKey (poolId))
			{
				...
				return objectToReuse.Reuse (position, rotation, parameters);
			}
			return null;
		}
	...
	public class ObjectInstance
	{
		...
		public GameObject Reuse(Vector3 position, Quaternion rotation, object parameters = null)
		{
